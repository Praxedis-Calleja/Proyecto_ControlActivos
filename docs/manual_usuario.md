...
5. Marca si el activo requiere baja. Si eliges **Sí**, se desplegarán los campos *Fecha de baja* y *Fecha de reimpresión* (opcional). La fecha de baja se rellena automáticamente con la fecha de diagnóstico cuando queda vacía.
